...
class ThemeManager private constructor(val context: Context) {
    ...
    companion object {
        ...
        const val THEME_REPO_URL = "https://github.com/marcelofp/haval-app-tool-multimidia/tree/codex/carplay-v301-stable-20260806/cluster-widgets/Themes/v1.0"
        ...
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                val apiUrl = if (info != null) {
                    ...
                    "https://api.github.com/repos/marcelofp/haval-app-tool-multimidia/contents/cluster-widgets/Themes/v1.0/${metadata.folderName}?ref=codex/carplay-v301-stable-20260806"
                }
