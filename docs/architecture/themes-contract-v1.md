...
4. Push to the branch `ThemeManager` crawls (currently `codex/carplay-v301-stable-20260806` in `marcelofp/haval-app-tool-multimidia` — see `ThemeManager.THEME_REPO_URL`).
