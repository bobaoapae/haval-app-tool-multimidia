...
REQUIRED_TOKENS = {
    ...
    "app/src/main/java/br/com/redesurftank/havalshisuku/projectors/InstrumentProjector2.kt": [
        ...
        "removes the user-selected display overlay",
    ...
    "app/src/main/java/br/com/redesurftank/havalshisuku/projectors/ProjectionDisplayHtmlPolicy.kt": [
        "ProjectionDisplayHtmlPolicy",
        "preserveUserDisplaySelection",
        "removedLegacyOverrides",
        "injectedCarPlayFullBleedMask",
        ...
        "return $stateGetter(\"display\")||\"Normal\"",
    ],
